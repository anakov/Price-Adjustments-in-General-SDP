% Main dynamics program: computes general equilibrium dynamics and shows impulse-responses
...
gridSpread   = 0;                              % extra spread for price grid as a share of (PMAX-PMIN)
finegrid     = 0;                              % fine (1) or coarse (0) grid
accuracy     = 2;                              % accuracy of SS calculation from 0 (lowest) to 4 (highest). Controls SS error tolerances.
